...
if __name__=="__main__":
    ...
    analyze_text(text=prompt, analyzer_name="funny_standard_lucene", index_name="fowlart_product_review_hybrid")
    ...
    # semantic_search(get_search_client("fowlart_product_review_hybrid"), analyzed_prompt)
