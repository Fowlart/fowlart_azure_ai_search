...
if __name__ == "__main__":
    ...
    """, "en.lucene", get_test_index_name(), get_search_index_client()))

    analyze_text("""I've read the author of "War of THE worlds": cool stuff""", "en.lucene", get_test_index_name())

    analyze_text("""I've read the author of "War of THE worlds": cool stuff""","en.microsoft", get_test_index_name())

    analyze_text(r"Dog+cat>pig are!=n=", "my_custom_analyzer", get_test_index_name())
