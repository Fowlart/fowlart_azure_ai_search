...
import mimetypes
import time
from utils.common_utils import get_tokens, get_search_index_client
...
class BaseIndexPopulator:
    ...
    def retrieve_files_metadata(self, root_dir: str) -> list[dict[str, str]]:
        """
        Retrieves metadata for files within the specified root directory.
